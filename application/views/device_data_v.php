                            ...
                            <div class="btn-group dropdown">
                                        ...
                                        <div class="input-daterange" data-plugin="datepicker">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group input-group-icon"
                                                    ...
                                                    <input type="text" class="form-control search-date" name="start"
                                                           value="<?= $date_str ?>" <?= (empty($search)) ? "disabled" : ""; ?> >
                              ...
                              <span class="icon md-calendar" aria-hidden="true"></span>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group input-group-icon"
                                                     style=" width: 100%; float: none; ">
                                                    <input type="text" class="form-control search-date" name="end"
                                                           value="<?= $date_end ?>" <?= (empty($search)) ? "disabled" : ""; ?>>
                                                    <span class="input-group-addon">
                              <span class="icon md-calendar" aria-hidden="true"></span>
                            </span>
                                                </div>
                                    ...
                                    <div id="checkbox-search" class="dropdown-item-form">
                                        <input type="checkbox" class="icheckbox-primary" id="searchState" name="search"
                                               data-plugin="iCheck"
                                               data-checkbox-class="icheckbox_flat-blue" <?= (empty($search)) ? "" : "checked"; ?>/>
                                        <label for="lastData">Search By Date</label>
                                        <button type="submit" id="ceks"
                                                class="btn btn-sm btn-primary waves-effect waves-classic waves-effect waves-classic"
                                                style="float:right;margin-top: -5px;">Apply
                                        </button>
                                    </div>
                                </div>
                            </div>
                ...
                <ul class="list-group list-group-bordered mb-0" style="font-size:15px;">
                    <?php foreach ($extract as $d) { ?>
                        <li class="list-group-item">
                            <span class="badge badge-pill badge-success" id="last-<?= $d ?>"
                                  style="padding:5px 10px;">-</span>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var reconnectTimeout = 2000,
            host = '<?= $this->config->item('host_mqtt')?>',
            port = <?= $this->config->item('port_mqtt')?>,
            topic = 'mqtt/output/<?= $topic; ?>';
    ...
    var data = '<?= (!empty($lastdata)) ? json_encode($lastdata) : ''; ?>'
    if(data)
