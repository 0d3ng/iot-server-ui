        ...
        <div class="col-md-12">
            <div class="panel">
                <div class="panel-heading">
                    <h3 class="panel-title">Form Edit Edge Configuration</h3>
                </div>    
                <div class="panel-body">
                    <div class="nav-tabs-horizontal" data-plugin="tabs">
                        <ul class="nav nav-tabs pearls row" role="tablist" style="border-bottom:none;">
                            <li class="nav-item pearl done current col-3" role="presentation" id="navDeviceConfiguration">
                            ...
                            <li class="nav-item pearl done col-3" role="presentation" id="navDataResource">
                            ...
                            <li class="nav-item pearl done col-3" role="presentation" id="navDataTransmitted">
                            ...
                            <li class="nav-item pearl done col-3" role="presentation" id="navFinalData">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group form-material ">
                                            ...
                                            <input type="number" class="form-control" id="inputTimeInterval" name="time_interval" onchange="validation1()"  value="<?= $edge->time_interval ?>"/>
                                        </div>
                                    </div>                                    
                                </div>
                                    ...
                                    <div class="col-md-4">   
                                        ...
                                        <div class="form-group form-material ">
                                            <select class="form-control " id="inputResouce" name="resource" required>
                                                ...
                                                <option value="<?= $d?>" <?= ($d == $edge->resource)?'selected':'' ?> ><?= $d?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane" id="dataTransmitted" role="tabpanel">                                
                                <div class="row">
                                    <div class="col-md-6">   
                                        ...
                                        <div class="form-group form-material ">
                                            <select class="form-control " id="inputComService" name="comeservice" required>
                                                ...
                                                <?php foreach ($commservice["list"] as $d) { ?>
                                                    <option value="<?= $d->type?>" <?= ($edge->comm_service==$d->type)?"selected":""; ?> ><?= $d->label?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <?php if( !empty($commservice["http_url"]) ){ ?>
                                        <div class="example-wrap" id="http-config" <?= ($edge->comm_service!="http_post")?'style="display:none"':""; ?> >
                                        ...
                                        <div class="example-wrap" id="mqtt-config" <?= ($edge->comm_service!="mqtt")?'style="display:none"':""; ?>>
                                        ...
                                        <div class="example-wrap">
                                            ...
                                            <div class="example">
                                                <table class="table table-hover" data-plugin="selectable" data-row-selectable="true">
                                                    ...
                                                    <tbody>
                                                        <?php 
                                                        $field_transmit = array();
                                                        $field_key = array();
                                                        foreach($edge->data_transmitted as $key => $value){
                                                            $field_transmit[$key] = $value; 
                                                            $field_key[] = $key;    
                                                        }
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <span class="checkbox-custom checkbox-primary">
                                                                    <input class="selectable-item" type="checkbox" name="data_transmitted[]" value="<?= $d ?>" <?= (in_array($d,$field_key))?"checked":""; ?> >
                                                                    <label for="row-619"></label>
                                                                </span>
                                                            </td>
                                                            <td><?= $d ?></td>
                                                            <td>
                                                                <select class="form-control transmited-data" id="field_<?= $d ?>"  name="field_<?= $d ?>">
                                                                    <option value="<?= $field_transmit[$d] ?>"><?= $field_transmit[$d] ?></option>
                                                                </select>   
                                                            </td>                                                            
                                                        </tr>  
                                                        <?php } ?>                                                     
...
<script>
    ...
    function showInterface(){
        ...
        $.ajax({
            type: 'post',
            url: '<?= base_url()?>device/resource/<?=$edge->edgeconfig_code ?>/',
