                <div class="col-md-4">
                  ...
                  <div class="example-wrap">
                    <h4 class="example-title" style="color:#0D47A1;">Interface Configuration</h4>
                    <div class="form-group form-material ">
                        <label class="form-control-label" for="inputConfigPort">USB Serial Port</label>
                        <input type="text" class="form-control" id="inputConfigPort" name="config['port']" value="<?= (empty($data->config->port))?'':$data->config->port;  ?>" 
                            placeholder="Edge Code" readonly="true"/>
                    </div>
                    <div class="form-group form-material ">
                        <label class="form-control-label" for="inputBaudrate">Baudrate</label>
                        <select class="form-control " id="inputConfigBaudrate" name="config['baudrate']" required>
                    ...
                    <div class="form-group form-material ">
                        ...
                        <input type="text" class="form-control" id="inputConfigTimeout" name="config['timeout']" value="<?= (empty($data->config->timeout))?'':$data->config->timeout;  ?>" 
                            placeholder="Edge Code" readonly="true"/>
                    </div>
                  </div>
                </div>
