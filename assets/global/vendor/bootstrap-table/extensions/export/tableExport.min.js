    ...
    d.fn.tableExport = function(k) {
        ...
        function R(b) {
            ...
            d(b).find("thead").first().find("th").each(function(b, c) {
                ...
                "undefined" !== typeof c.parentNode.rowIndex && p !== c.parentNode.rowIndex && (p = c.parentNode.rowIndex, e = f = 0);
                var l = J(c);
                for (e += l ? l : 1; f < e;) a[f] = b ? d(c).attr("data-field") : f.toString(), f++
            });
            return a
        }
        ...
        function ua(b, a, e, d) {
            if ("undefined" !== typeof d.images && (e = d.images[e], "undefined" !== typeof e)) {
                ...
                try {
                    d.doc.addImage(e.src, b.textPos.x, b.y + g, p, h)
                } catch (Pa) {}
                b.textPos.x +=
                    p
            }
        ...
        function na(b) {
            b = b || "0";
            "" !== a.numbers.html.thousandsSeparator && (b = V(b, a.numbers.html.thousandsSeparator, ""));
            "." !== a.numbers.html.decimalMark && (b = V(b, a.numbers.html.decimalMark, "."));
        ...
        function Ca(b) {
            ...
            a = {
                style: {
                    align: a,
                    bcolor: ea(M(b, "background-color"), [255, 255, 255]),
                    color: ea(M(b, "color"), [0, 0, 0]),
                    fstyle: f
                },
                colspan: J(b),
                rowspan: T(b)
        ...
        function N(b, c, d, p, f, l) {
            ...
            if (e) try {
                if (Ea = new Blob([b], {
                        type: d + ";charset=" + p
                    }), saveAs(Ea, c, !1 === l), "function" === typeof a.onAfterSaveToFile) a.onAfterSaveToFile(b, c)
            } catch (h) {
                ka(c,
        ...
        function ka(b, c, d) {
            ...
            if (!1 !== b && window.navigator.msSaveOrOpenBlob) window.navigator.msSaveOrOpenBlob(new Blob([d]), b);
                ...
                if (f) {
                    ...
                    "object" === typeof d ? (window.URL = window.URL || window.webkitURL, e = [], e.push(d), l = window.URL.createObjectURL(new Blob(e, {
                            type: c
                        })), f.href = l) : 0 <= c.toLowerCase().indexOf("base64,") ?
        ...
        if ("csv" === a.type || "tsv" === a.type || "txt" === a.type) {
            ...
            v(d(B), "tbody").each(function() {
                Y += qa(v(d(this), a.tbodySelector), "td,th", Y)
            });
            ...
            d(r).each(function() {
                var a = [];
                E(this, "th,td", n, r.length, function(b, d, g) {
                    a.push(D(b, d, g))
                });
                W.push(a)
            });
            ...
            k = "head" === a.jsonScope ? JSON.stringify(W) : "data" === a.jsonScope ? JSON.stringify(ra) : JSON.stringify({
                header: W,
                data: ra
            });
            ...
            r = y(d(B));
            d(r).each(function() {
                E(this, "th,td", n, r.length, function(a, d, e) {
                        ...
                        E(this, "td,th", n, c + a.length, function(a, c, l) {
                            if (null !== a) {
                                ...
                                if (!1 !== jQuery.isNumeric(c)) l = "Number";
                                    ...
                                    var g = Ma(c);
                                    !1 !== g && (c = g, l = "Number", h += ' ss:StyleID="pct1"')
                                }
            ...
            d(B).filter(function() {
                ...
                for (var b = d(this), c = {}, e = this.getElementsByTagName("tr"), g = {
                    ...
                    }, f = [], l, q = [], h = 0, u = 0, k, m, n, t, r, w = XLSX.SSF.get_table(); h < e.length && 1E7 > u; ++h)
                        ...
                        for (k = m = 0; k < y.length; ++k)
                            if (r = y[k], t = +J(r) || 1, l = k + z, !ta(d(r), B, l + (l < m ? m - l : 0))) {
                                ...
                                if (null != l)
                                    ...
                                    "href" !== a.htmlHyperlink ? l : "", v = {
                                        f: '=HYPERLINK("' + d(r).find("a").attr("href") + (l.length ? '","' + l : "") + '")'
                                    };
                                else if ("n" === A || isFinite(Da(l, a.numbers.output))) {
                                    if (r = Da(l, a.numbers.output), 0 === x && "function" !== typeof a.mso.xslx.formatId.numbers && (x = a.mso.xslx.formatId.numbers), isFinite(r) || isFinite(l)) v = {
                                        t: "n",
                                        v: isFinite(r) ? r : l,
                                        z: "string" === typeof x ? x : x in w ? w[x] : "0.00"
                                    }
                                } else if (!1 !== (r = La(l)) || "d" === A) 0 === x && "function" !== typeof a.mso.xslx.formatId.date && (x = a.mso.xslx.formatId.date), v = {
                                    t: "d",
                                    v: !1 !== r ?
                                        r : l,
                        ...
                        if (null !== d) {
                            ...
                            if (a.mso.styles.length) {
                                var g = document.defaultView.getComputedStyle(d,
                                    ...
                                    k;
                                for (k in a.mso.styles) {
                                    var m = g[a.mso.styles[k]];
                                    "" === m && (m = h[a.mso.styles[k]]);
                                    "" !== m && "0px none rgb(0, 0, 0)" !== m && "rgba(0, 0, 0, 0)" !== m && (e += "" === e ? 'style="' : ";", e += a.mso.styles[k] + ":" + m)
                                }
                            }
                            "" !== e && (t += " " + e + '"');
                            e = J(d);
            ...
            if (!0 === a.pdfmake.enabled) {
                ...
                d(B).filter(function() {
                    ...
                    ia.content.push({
                        ...
                        pageBreak: ia.content.length ? "before" : void 0
                    })
                });
                "undefined" !== typeof pdfMake && "undefined" !== typeof pdfMake.createPdf &&
                    ...
                    }, pdfMake.vfs.hasOwnProperty("Mirza-Regular.ttf") ? (a.pdfmake.docDefinition.defaultStyle.font = "Mirza", d.extend(!0, pdfMake.fonts, {
                        Mirza: {
                    ...
                    })) : pdfMake.vfs.hasOwnProperty("gbsn00lp.ttf") ? (a.pdfmake.docDefinition.defaultStyle.font = "gbsn00lp", d.extend(!0, pdfMake.fonts, {
                        gbsn00lp: {
                            normal: "gbsn00lp.ttf",
                            bold: "gbsn00lp.ttf",
                    ...
                    })) : pdfMake.vfs.hasOwnProperty("ZCOOLXiaoWei-Regular.ttf") && (a.pdfmake.docDefinition.defaultStyle.font = "ZCOOLXiaoWei", d.extend(!0, pdfMake.fonts, {
                        ZCOOLXiaoWei: {
                    ...
                    })), d.extend(!0, pdfMake.fonts, a.pdfmake.fonts), pdfMake.createPdf(ia).getBuffer(function(b) {
                        N(b, a.fileName +
            ...
            k = {
                dim: {
                    w: fa(d(B).first().get(0), "width", "mm"),
                    h: fa(d(B).first().get(0), "height", "mm")
                },
                pagesplit: !1
            };
            ...
            Ka(g, function() {
                d(B).filter(function() {
                    ...
                    "function" !== typeof c.drawHeaderCell && (c.drawHeaderCell = function(a, b) {
                        ...
                        return (!0 !== d.style.hasOwnProperty("hidden") || !0 !== d.style.hidden) && 0 <= d.rowIndex ? wa(a, b, d) : !1
                    });
